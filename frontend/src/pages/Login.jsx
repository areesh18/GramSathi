...
const Login = () => {
  ...
  const handleGuestLogin = () => {
    // Create a dummy guest user in localStorage
    const guestUser = {
      id: "guest",
      name: "Guest User",
      role: "user",
  ...
  return (
    <div className="min-h-screen bg-blue-700 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        {isOffline && (
          <div className="mb-6 bg-yellow-50 border border-yellow-200 p-4 rounded-xl text-center animate-pulse">
        ...
        {/* Hide Standard Login Form if Offline (Optional, or keep it disabled) */}
        {!isOffline && (
          <form onSubmit={handleAuth} className="space-y-4">
            {/* ... existing form inputs ... */}
            {/* Use {t('login')} for button text */}
          </form>
        )}
        <div className="p-8">
          <div className="text-center mb-8">
